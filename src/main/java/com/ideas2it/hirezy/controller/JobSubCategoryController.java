 ...
 */
@RestController
@RequestMapping("admins/job-subcategories")
public class JobSubCategoryController {
     ...
     */
    @PutMapping
    public ResponseEntity<JobSubCategoryDto> updateJobSubCategory( @Valid @RequestBody JobSubCategoryDto jobSubCategoryDto) {
